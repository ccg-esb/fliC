...
function out = fZ(~,y,params)
    ...
    %mRNAs:
    drAZ=params.maz*hillA(DC, params.thetaDC, params.nh) - params.gammaAZ*rAZ;
    drV=params.mv*hillI(AZ, params.thetaAZ, params.nh) - params.gammaV*rV;
